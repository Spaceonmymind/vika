...
#[Attribute]
class FetchActirovkiForSpecificDay extends OA\Get
{
    public function __construct()
    {
        parent::__construct(
            path: '/api/widget/actirovki/cities/{city}/actirovki/specific-day',
            operationId: 'FetchActirovkiForSpecificDayActirovkiWidget',
            summary: 'Получить актировки за конкретную дату',
            ...
            parameters: [
                ...
                new OA\Parameter(
                    ...
                    in: 'query',
                    required: true,
                    schema: new OA\Schema(type: 'string', format: 'date', example: '15.05.2025'),
                ),
            ],
            responses: [
                new OA\Response(

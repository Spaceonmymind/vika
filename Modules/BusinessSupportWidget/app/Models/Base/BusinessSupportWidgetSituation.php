...
/**
 * Class BusinessSupportWidgetSituation
 *
 * @property int $id
 ...
 */
class BusinessSupportWidgetSituation extends Model
{
	protected $table = 'business_support_widget_situations';
	public $timestamps = false;

	public function business_support_widget_measures():HasMany
	{
		return $this->hasMany(BusinessSupportWidgetMeasure::class, 'situation_id');
	}
}

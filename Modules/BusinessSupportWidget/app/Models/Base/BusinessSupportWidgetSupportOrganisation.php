...
/**
 * Class BusinessSupportWidgetSupportOrganisation
 *
 * @property int $id
 ...
 */
class BusinessSupportWidgetSupportOrganisation extends Model
{
	protected $table = 'business_support_widget_support_organisations';
	public $timestamps = false;

	public function business_support_widget_measures():HasMany
	{
		return $this->hasMany(BusinessSupportWidgetMeasure::class, 'support_organisation_id');
	}
}

...
#[Attribute]
class AddTestRequestTotIntent extends OA\Post
{
    public function __construct()
    {
        parent::__construct(
            path: '/api/admin/chat/intents/{intent}/test_requests/create',
            operationId: 'addTestRequest',
            summary: 'Добавить пример вопроса к инетенту',

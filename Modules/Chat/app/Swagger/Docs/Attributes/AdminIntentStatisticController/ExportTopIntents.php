...
#[Attribute]
class ExportTopIntents extends OA\Get
{
    public function __construct()
    {
        parent::__construct(
            path: '/api/admin/chat/intents/statistic/export_top',
            operationId: 'exportTopIntents',
            summary: 'Экспорт топа интентов в Excel',

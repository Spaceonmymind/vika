...
abstract class AbstractSourceHandler implements OpenDataHandler
{
    ...
    protected const string TELEGRAM_LOG_CHANEL = 'telegram_districts';
    protected static int $rowNumber = 0;

    /**
     * @throws Exception
     */
    public static function handle(array $data, DistrictSearchWidgetOdDataset $dataset): void
    {
        ...
        try {
            ...
            Log::channel(static::DATASET_LOG_CHANEL)->error('od_handler_error Ошибка при обновлении информации об участках',
                [
            ...
            Log::channel(static::TELEGRAM_LOG_CHANEL)->error('Возникла непредвиденная ошибка при обновлении информации об участках',);
        }
    }
    ...
    abstract protected static function processData(array $data, DistrictSearchWidgetOdDataset $dataset);
}

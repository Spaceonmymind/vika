    ...
    */
    ...
    '*' => [
        ...
        */
        ...
        |               (post.author --> user.id)
                            generates Post::user() and UserProfile::posts()
        |
        ...
        |                       generates Post::author() and UserProfile::posts_where_author()
        |                   (post.editor_id --> user.id)
        |                       generates Post::editor() and UserProfile::posts_where_editor()
        ...
        */
        ...
        /*
         ...
         |
         | ...
         | $builder->select([UserProfile::USER_NAME])->where(UserProfile::AGE, '<=', 18);
         | ...
         |

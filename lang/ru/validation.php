    ...
    */
    ...
    'custom' => [
        ...
        'user.email' => [
            ...
            'email' => 'Адрес электронной почты должен быть корректным адресом электронной почты формата "email@example.ru"',
        ],
        'email' => [
            'exists' => 'Нет пользователя с таким адресом электронной почты',
        ],
        'resources.*' => [
            'unique' => 'Ресурс №:position уже существует в другом типе Вики',
        ],
    ],
